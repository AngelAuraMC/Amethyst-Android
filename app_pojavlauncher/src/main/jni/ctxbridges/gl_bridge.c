...
gl_render_window_t* gl_init_context(gl_render_window_t *share) {
    ...
    // Additionally it requires different depth/alpha size or we'll receive zero matching configs
    // Ugh...
    EGLint egl_attributes[] = {
            EGL_BLUE_SIZE, 8,
            EGL_GREEN_SIZE, 8,
            EGL_RED_SIZE, 8,
            EGL_ALPHA_SIZE, gl_ctx ? 0 : 8,
            EGL_DEPTH_SIZE, gl_ctx ? 16 : 24,
            EGL_SURFACE_TYPE, EGL_WINDOW_BIT | EGL_PBUFFER_BIT,
            EGL_RENDERABLE_TYPE, gl_ctx ? EGL_OPENGL_BIT : EGL_OPENGL_ES2_BIT,
            EGL_NONE
    };
