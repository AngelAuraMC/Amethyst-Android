...
import org.angelauramc.methodsInjectorAgent.mod_compatibility_injector.DistantHorizonsZstdVersionOverrideInjector;
...
public class startInjectors {
    public static void premain(String args, Instrumentation inst) {
        try {
            ...
            DistantHorizonsZstdVersionOverrideInjector.premain(args, inst);
